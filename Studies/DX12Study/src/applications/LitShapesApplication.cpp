#include "LitShapesApplication.h"
...
namespace Studies
{
    void LitShapesApplication::Initialize(HWND mainWindow, int windowWidth, int windowHeight)
    {
        assert(mainWindow);
    ...
    void LitShapesApplication::Tick()
    {
        m_Timer.Tick();
    ...
    void LitShapesApplication::SetNextFrameResource()
    {
    ...
    void LitShapesApplication::Draw()
    {
    ...
    void LitShapesApplication::UpdateObjectConstantBuffers()
    {
    ...
    void LitShapesApplication::UpdatePassConstantBuffer()
    {
    ...
    void LitShapesApplication::UpdateCamera()
    {
    ...
    void LitShapesApplication::CreateConstantBufferViews()
    {
    ...
    void LitShapesApplication::SetupRenderItems()
    {
    ...
    void LitShapesApplication::CreatePipelineStateObjects()
    {
