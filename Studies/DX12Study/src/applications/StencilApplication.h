...
namespace Studies
{
    ...
    private:
        ...
        std::unordered_map<std::string, Microsoft::WRL::ComPtr<ID3DBlob>> m_VertexShaderBytecodes{};
        std::unordered_map<std::string, Microsoft::WRL::ComPtr<ID3DBlob>> m_PixelShaderBytecodes{};
