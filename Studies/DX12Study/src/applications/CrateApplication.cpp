...
namespace Studies
{
    void CrateApplication::Initialize(HWND mainWindow, int windowWidth, int windowHeight)
    {
        assert(mainWindow);
    ...
    void CrateApplication::SetNextFrameResource()
    {
    ...
    void CrateApplication::DrawRenderItems(ID3D12GraphicsCommandList& commandList, const std::vector<RenderItem*>& renderItems)
    {
    ...
    void CrateApplication::UpdateObjectConstantBuffers()
    {
    ...
    void CrateApplication::UpdatePassConstantBuffer()
    {
    ...
    void CrateApplication::UpdateMaterialConstantBuffers()
    {
    ...
    void CrateApplication::UpdateCamera()
    {
    ...
    void CrateApplication::UpdateSun()
    {
    ...
    DirectX::XMFLOAT3 CrateApplication::GetSunDirection()
    {
    ...
    void CrateApplication::CreateRootSignature()
    {
    ...
    void CrateApplication::CreateFrameResources()
    {
    ...
    void CrateApplication::SetupWaves()
    {
    ...
    DirectX::XMFLOAT3 CrateApplication::GetHillsNormal(float x, float z)
    {
        // n = (-df/dx, 1, -df/dz)
    ...
    DirectX::XMFLOAT4 CrateApplication::GetHillsColor(float y)
    {
        if (y < -10.f)
        {
            // Sandy beach color
    ...
    void CrateApplication::UpdateWaves()
    {
    ...
    void CrateApplication::CreatePipelineStateObjects()
    {
